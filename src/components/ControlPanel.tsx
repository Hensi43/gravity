                    ...
                    {status === 'complete' && (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="px-8 py-4 rounded-xl bg-green-500 text-black font-bold text-lg hover:bg-green-400 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 mx-auto"
                            >
